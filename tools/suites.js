...
export const FAST = [
  ...
  { file: 'test/page-view.test.js', why: 'собранная страница в настоящем DOM: дерево, пустота, оформление, переключение — сборок две, обе на общей фикстуре' },
...
export const SLOW = [
  ...
  { file: 'test/doctor.test.js', why: 'диагностика на шести состояниях проекта: по прогону инструмента на состояние и на проверку' },
