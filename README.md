...
|---|---|---|---|
| Быстрый — каждая правка | `pnpm test` | **56 из 127** | **≤ 10 с** |
| Полный — выкладка и CI | `pnpm test:all` | **127** | **≤ 28 с** |

Ни одна проверка не потеряна и не ослаблена: полный прогон запускает все 127 теми же
