...
удалениями больше не тупик»); всего 77.
...
**11,0 с** при 77 проверках (три прогона: 11,00 / 10,86 / 11,02, плюс 11,12 в среде
без настроек машины; из них 6,7 с — файл токенов), поэтому цель — `pnpm test`
**≤ 13 с** (запас ~1,9 с), `pnpm run parity:live` **≤ 15 с** (7,4 с в обеих средах).
