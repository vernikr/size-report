...
```bash
pnpm add -D github:vernikr/size-report#4b8dc8d   # любой коммит или тег
```
...
человек получил бы ноль и решил, что всё в порядке. За этим следит сторож
документации (`test/docs.test.js`): пин обязан вести на ревизию этого
репозитория, и все названные в тексте команды обязаны быть в её справке.
