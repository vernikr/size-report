...
|---|---|---|
| Быстрый — каждая правка | `pnpm test` | **65 из 164** |
| Полный — выкладка и CI | `pnpm test:all` | **164** |

Ни одна проверка не потеряна и не ослаблена: полный прогон запускает все 164 теми же
