...
|---|---|---|---|
| Быстрый — каждая правка | `pnpm test` | **56 из 129** | **≤ 10 с** |
| Полный — выкладка и CI | `pnpm test:all` | **129** | **≤ 28 с** |

Ни одна проверка не потеряна и не ослаблена: полный прогон запускает все 129 теми же
