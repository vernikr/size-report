...
|---|---|---|
| Быстрый — каждая правка | `pnpm test` | **65 из 162** |
| Полный — выкладка и CI | `pnpm test:all` | **162** |

Ни одна проверка не потеряна и не ослаблена: полный прогон запускает все 162 теми же
