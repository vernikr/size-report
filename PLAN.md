...
месте. Вычислительная часть страницы — не пересказ, а исходники тех же функций,
которые считают артефакт (`DERIVED_SRC`): второго расчёта нет, и проверка контракта
