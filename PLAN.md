...
|---|---|---|
| `pnpm test` — 12 проверок, 8 с | Фикстура в четырёх чужих окружениях: `--json` побайтово, sha256 артефакта, контрольный режим — для движка пакета и рядом для эталонной копии | 12 из 12 |
...
- `BLOCKERS.md` — открытые блокеры и известные пробелы (сейчас — §B2).
