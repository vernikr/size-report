...
**Осталось из шага 2:** запоминание выбора в браузере (`localStorage` и
`location.hash`), пре-собранный `dist/app.js` вместо текста в движке и отказ от
«отчёта в git» в проекте-потребителе. Внешний вид страницы сделан раньше
(`REFACTOR.md` R-2.2).
