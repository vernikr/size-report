...
| `docs` | ✅ есть: утверждения документации о репозитории — пути, таблица файлов ↔ дерево, команды и ключи из справки, число проверок и цели по времени, адреса разделов, а с R-4.13 — и пин в примере установки: он ведёт на ревизию **этого** репозитория, и её справка знает названные в тексте команды (`test/docs.test.js`) | Обещания будущего, формулировки и смысл — вне проверки, названо в её шапке |
