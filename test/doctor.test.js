 ...
 * обрезанной историей (3) и без необязательной зависимости (4). Ответ обязан
 * совпадать с состоянием, а не быть всегда зелёным, — поэтому коды выхода и
 * названные причины и есть предмет проверки.
 *
 ...
 *
 * Цена названа в бюджете времени (`REFACTOR.md` §3): случаев пять, каждый — прогон
