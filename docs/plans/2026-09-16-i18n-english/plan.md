...
read 189** (235 before W1 started: −10 in step 1, −13 in step 2, −23 in step 3; 192 once N29's repair (1) is taken), and the `tools/**` family reads 392 rather than 452 — the rows of the
