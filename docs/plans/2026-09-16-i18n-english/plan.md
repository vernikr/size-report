...
read 30** (235 before W1 started: −10 in step 1, −13 in step 2, −23 in step 3, −74 in step 4, −29 in step 6, −1 in step 7, −55 in step 8; step 5 needed no edit at all; 24 once N29's repair (1) is taken), and the `tools/**` family reads 233 rather than 452 — the rows of the
