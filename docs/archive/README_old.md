...
| `docs/archive/README_old.md` | This document: the README this project used to put on its main page, kept whole after the main page became a short landing description. No longer maintained; the tool's settings it describes still stand |
