...
- CRLF в текстовом файле — при `core.autocrlf=true` выкладка такого файла необратима (сам git про это предупреждает), и сверка с рабочим деревом не имеет права на нём падать
